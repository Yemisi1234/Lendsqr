...
import {MdGroups, MdMiscellaneousServices, MdPayments} from 'react-icons/md';
    ...
    return (
        <div className="sidebar">
            <div className="sidebar-container">
                <h3 className="sidebar-header"><IoBriefcase className="sidebar-header-icon" />Switch Organization</h3>
            ...
            <div className="side-items-container">
                ...
                <ul className="side-items">
                    {navItems.map(item => (<li className="side-item"><Link className="side-link">{item.icon} {item.name}</Link></li>))}
                </ul>
                <h4 className="side-items-header">BUSINESSES</h4>
                <ul className="side-items">
                    {navItems2.map(item => (<li className="side-item"><Link className="side-link">{item.icon} {item.name}</Link></li>))}
                </ul>
                <h4 className="side-items-header">SETTINGS</h4>
                <ul className="side-items">
                    {navItems3.map(item => (<li className="side-item"><Link className="side-link">{item.icon} {item.name}</Link></li>))}
                </ul>
            </div>
        </div>
    )
