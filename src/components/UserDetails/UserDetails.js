  ...
  return (
    <div className="user-details">
      ...
      <div className="details-main">
        <Link to="/users" className="return-link">
          <IoIosArrowRoundBack className="return-arrow" />
          Back to Users
        </Link>
        ...
        <div className="user-info">
          <div className="user-info-header">
            <div className="user-info-name-container">
              ...
              <h3 className="user-profile-name">
                ...
                <br />
                <span className="user-id">{info.id.substring(0, 10)}</span>
              </h3>
            </div>
            <div className="user-info-name-container">
              <h3 className="user-profile-name">
            ...
            <div className="user-info-name-container">
              <h3 className="user-profile-name">
                ₦{info.balance}
                <br />
                <span className="user-id">0464634532/Providus Bank</span>
              </h3>
            </div>
          </div>
          ...
          <div className="personal-info">
            <div className="personal-info-section">
              <h3 className="personal-info-heading">
              ...
              <div className="personal-info-body-2">
                ...
                <div className="span-container">
                  ...
                  <span className="detail-value">
                    {info.isActive ? "Employed" : "Unemployed"}
                  </span>
                </div>
                <div className="span-container">
